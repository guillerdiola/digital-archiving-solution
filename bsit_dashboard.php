...
<head>
    ...
    <title>BSIT Research File Dashboard</title>
...
<body>
    <div class="container">
        ...
        <h1>Research File Dashboard</h1>
        <h2>Program: <?php echo htmlspecialchars($program); ?></h2>

        <div class="chart-container">
            <div>
                <canvas id="barChart" class="chart"></canvas>
                <p style="text-align: center; color: #333;">Bar Chart</p>
            </div>
            <div>
                <canvas id="lineChart" class="chart"></canvas>
                <p style="text-align: center; color: #333;">Line Chart</p>
            </div>
            <div>
                <canvas id="pieChart" class="chart"></canvas>
                <p style="text-align: center; color: #333;">Pie Chart</p>
            </div>
        </div>
    </div>
